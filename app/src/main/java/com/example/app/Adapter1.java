...
public class Adapter1 extends FirebaseRecyclerAdapter<Activity, Adapter1.myViewHolder> {
    ...
    public Adapter1(@NonNull FirebaseRecyclerOptions<Activity> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull Adapter1.myViewHolder holder, int position, @NonNull Activity model) {
    ...
    public Adapter1.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Adapter1.myViewHolder(view);
    }

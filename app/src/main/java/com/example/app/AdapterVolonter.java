...
public class AdapterVolonter extends FirebaseRecyclerAdapter<Activity, AdapterVolonter.myViewHolder> {
    ...
    private AdapterVolonter.OnItemClickListener listener;
    public AdapterVolonter(@NonNull FirebaseRecyclerOptions<Activity> options) {
        super(options);
    }
    ...
    public void setOnItemClickListener(AdapterVolonter.OnItemClickListener listener)
    {
